...
<table class="table table-bordered table-sm mymargin5">
	...
	<tr>
		...
		@if($row -> director_image)
			<img src="{{ asset('/storage/director_img/'. $row->director_image) }}" width="300" heigth="250"
...
<div align="center">
    <a href="{{ route('admin_director.edit', $row->id) }}{{ $tmp }}" class="btn btn-sm mycolor1">수정</a>
	<form action = "{{ route('admin_director.destroy', $row->id)}}">
		@csrf
		@method('DELETE')
