...
<div class="page-single movie-single movie_single">
        ...
        <p class="text">총 <span id="count">0</span> 인 가격은 <span id="costs">0</span>원 입니다.</p>
	...
	@csrf
						...
						<div class="row">
							<div class="col-md-6 form-it">
								<label>날짜</label>
              			<input type = "date" name="run_date" value = "{{old('run_date')}}">날짜를 선택하세요.</input>
...
@foreach ($list2 as $row)
		...
		@endforeach
					...
					<div class="col-md-6">
							<form action="{{ route('ticketing.create', $row->id) }}">
								@csrf
