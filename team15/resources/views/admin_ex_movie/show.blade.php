...
<table class="table table-bordered table-sm mymargin5">
	...
	<tr>
        ...
        <td width = "80%" align="left">{{ $row->actor_name }} {{ $row1->actor_name }}</td>
    </tr>
...
<div align="center">
    <a href="{{ route('admin_ex_movie.edit', $row->id) }}{{ $tmp }}" class="btn btn-sm mycolor1">수정</a>
	<form action = "{{ route('admin_ex_movie.destroy', $row->id)}}">
		@csrf
		@method('DELETE')
