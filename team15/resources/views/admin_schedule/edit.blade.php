...
<form name = "form1" method="post" action="{{ route('admin_schedule.update',$row->id) }}{{ $tmp }}"
...
<table class="table table-bordered table-sm mymargin5">
	...
	<tr>
        ...
        <td align="left">
			<input  type="date" name="run_date" value = "{{$row->run_date}}" class="form-control form-control-sm" style="width:25%">
