...
<form name = "form1" method="post" action="{{ route('admin_movie.store') }}{{ $tmp }}"
...
<table class="table table-bordered table-sm mymargin5">
    ...
    <td width="20%" class="mycolor2">상태(1=예정,0=상영중)</td>
        <td align="left">
			<input  type="text" name="state" value = "{{old('state')}}" class="form-control form-control-sm" style="width:25%">
        </td>
    </tr>
    </tr>
</table>
