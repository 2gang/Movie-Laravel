...
<form name = "form1" method="post" action="{{ route('admin_member.store') }}{{ $tmp }}">
@csrf
...
<table class="table table-bordered table-sm mymargin5">
	...
	<tr>
        ...
        <td align="left">
			<input  type="text" name="uid" value = "{{old('uid')}}" class="form-control form-control-sm" style="width:25%">
	...
	<tr>
        ...
        <td align="left">
			<input  type="text" name="pwd" value = "{{old('pwd')}}" class="form-control form-control-sm" style="width:25%">
