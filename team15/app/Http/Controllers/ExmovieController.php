...
class ExmovieController extends Controller
{
    /**
    ...
    public function index()
    {
		...
		return view( 'ex_movie.index', $data );	// 자료 표시(view/Movie폴더의 index.blade.php)
	    ...
	    public function state()
    {
		...
		return view( 'movie.state', $data );	// 자료 표시(view/Movie폴더의 index.blade.php)
	...
	{
		$result=Movie::orderby('state')->get();
		return $result;
	}
